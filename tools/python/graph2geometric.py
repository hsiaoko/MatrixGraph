    ...
    def read_graph(self, filepath: str) -> nx.Graph:
        ...
        for line in lines:
            ...
            if parts[0] == 't':
                ...
                self.graph.nodes[vertex_id]['name'] = vertex_label
...
# 保存为gpickle.gz格式
def save_data_to_gpickle_gz(data, filename):
...
def main():
    ...
    # write_serialized_data(graph, sys.argv[2] + 'gpickle.gz')
    save_data_to_gpickle_gz(graph, sys.argv[2] + 'data_graph.gpickle.gz')
